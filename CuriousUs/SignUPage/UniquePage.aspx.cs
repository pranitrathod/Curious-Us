        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (txt1.Text != "")
            {
                ...
                try
                {
                    ...
                    con.Open();
                    cmd.Connection = con;
                    cmd.CommandText = "select * from UniqueID where Uniqueid='" + txt1.Text + "'";
                    ...
                    { Response.Write("<html><body><script>{alert('You Dont Have your Unique ID  Please Go to the Admission Center')}</script></body></html>"); }
